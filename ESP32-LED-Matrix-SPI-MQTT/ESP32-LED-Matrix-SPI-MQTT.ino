...
const char* MQTT_TOPIC = "my/topic/here";
const char* INITTEXT = "Occupied"; // inittext displayed until MQTT message subscribed
const int SCROLLSPEED = 10;
const int BRIGHTNESS = 5; // Brightness 0 ... 15
